...
This screen has 6 tabs:
  ...
  - :ref:`Preview <app-designer-overview-preview>` (shown above) - used to preview `ODK-X Survey <https://docs.odk-x.org/survey-using/>`_ forms and ODK-X Tables list-views and detail-views (in the future). Displays these within a user-selected device geometry.
