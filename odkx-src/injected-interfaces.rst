...
This section will walk you through the steps of implementing a barcode scanner in a custom ODK-X Table
using the ``odkCommon.doAction`` to launch an intent.
